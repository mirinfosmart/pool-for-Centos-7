...
################################################################################
    ...
    hide_output sudo yum -y update 
    hide_output sudo yum -y upgrade
    hide_output sudo yum -y autoremove
    yum install dialog python3 python3-pip acl nano apt-transport-https
    ...
    if [[ ("$DISTRO" == "16") ]]; then
    yum install php7.3-fpm php7.3-opcache php7.3 php7.3-common php7.3-gd php7.3-mysql php7.3-imap php7.3-cli \
    ...
    yum install libgmp3-dev libmysqlclient-dev libcurl4-gnutls-dev libkrb5-dev libldap2-dev libidn11-dev gnutls-dev \
    ...
    yum install software-properties-common build-essential
    yum install libtool autotools-dev automake pkg-config libssl-dev libevent-dev bsdmainutils git cmake libboost-all-dev zlib1g-dev libz-dev libseccomp-dev libcap-dev libminiupnpc-dev gettext
    yum install libminiupnpc10 libzmq5
    yum install libcanberra-gtk-module libqrencode-dev libzmq3-dev
    yum install libqt5gui5 libqt5core5a libqt5webkit5-dev libqt5dbus5 qttools5-dev qttools5-dev-tools libprotobuf-dev protobuf-compiler
    hide_output sudo add-apt-repository -y ppa:bitcoin/bitcoin
    hide_output sudo apt -y update
    yum install libdb4.8-dev libdb4.8++-dev libdb5.3 libdb5.3++
    echo -e "$GREEN Done...$COL_RESET"
